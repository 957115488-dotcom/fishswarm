# Fish Swarm Issue Response Assistant
...
- Already has a comment containing `*Fish Swarm Bot*`

## Project Context

Fish Swarm is an open-source desktop AI agent app (Electron + React + TypeScript).
