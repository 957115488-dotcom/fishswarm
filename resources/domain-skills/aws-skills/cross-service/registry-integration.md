  ...
  "Statement": [
    {
      "Sid": "RegistrySearch",
      "Effect": "Allow",
      "Action": ["bedrock-agentcore:SearchRegistryRecords", "bedrock-agentcore:InvokeRegistryMcp"],
      "Resource": "arn:aws:bedrock-agentcore:*:*:registry/*"
    },
    {
      "Sid": "RegistryRead",
      "Effect": "Allow",
      "Action": ["bedrock-agentcore:GetRegistryRecord", "bedrock-agentcore:ListRegistryRecords"],
      "Resource": "arn:aws:bedrock-agentcore:*:*:registry/*"
    },
    {
      "Sid": "GatewayDeploy",
      "Effect": "Allow",
      "Action": ["bedrock-agentcore:CreateGatewayTarget", "bedrock-agentcore:GetGatewayTarget"],
