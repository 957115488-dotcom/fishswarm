...
const LEGACY_CLEANUP_ARTIFACTS = [
  {
    source: path.join('resources', 'windows', 'Fish-Swarm-Legacy-Cleanup.cmd'),
    target: 'Fish-Swarm-Legacy-Cleanup.cmd',
  },
  {
    source: path.join('resources', 'windows', 'Fish-Swarm-Legacy-Cleanup.ps1'),
    target: 'Fish-Swarm-Legacy-Cleanup.ps1',
  },
];
