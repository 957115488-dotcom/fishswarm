...
import sidebarLogoSrc from '../assets/logo-transparent.png';
...
export function Sidebar() {
  ...
  if (sidebarCollapsed) {
    return (
      <aside className="w-[4.5rem] h-full min-h-0 bg-surface/96 border-r border-border-muted flex flex-col overflow-hidden">
        ...
        <div className="flex-1 min-h-0 flex flex-col items-center justify-center px-3 py-4">
          <button
            onClick={toggleSidebar}
  ...
  return (
    <aside className="w-[17.5rem] h-full min-h-0 bg-surface/96 border-r border-border-muted flex flex-col overflow-hidden">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex items-center gap-3">
            <img
              ...
              className="app-logo-mark w-10 h-10 object-contain flex-shrink-0"
            />
